...
yarn prettier --write "packages/crafty-preset-react/*.js"
...
yarn node ../crafty-preset-babel/src/commands/jsLint.js --fix --preset recommended --preset node *.js

echo "${GREEN}Linting crafty$NC"
cd "$DIR/packages/crafty"
yarn node ../crafty-preset-babel/src/commands/jsLint.js --fix --preset recommended --preset node src/**/*.js
...
yarn node ../crafty-preset-babel/src/commands/jsLint.js --fix --preset recommended --preset node *.js src/**/*.js

echo "${GREEN}Linting integration$NC"
cd "$DIR/packages/integration"
yarn node ../crafty-preset-babel/src/commands/jsLint.js --fix --preset recommended --preset node *.js __tests__/*.js

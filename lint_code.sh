...
yarn node ../crafty-preset-eslint/src/commands/jsLint.js --fix --preset recommended --preset node src
...
yarn node ../crafty-preset-eslint/src/commands/jsLint.js --fix --preset recommended --preset node *.js src

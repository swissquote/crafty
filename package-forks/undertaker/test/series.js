...
function fnError(done) {
  ...
  test('should throw when no tasks specified', function(t) {
    ...
    t.throws(fail, { message: /One or more tasks should be combined using series or parallel/ });
  });
  ...
  test('should take only one array of registered tasks', async function(t) {
    await new Promise((resolve, reject) => taker.series(['test1', 'test2', 'test3'])(function(err, results) {
  ...
  test('should take all functions', async function(t) {
    await new Promise((resolve, reject) => taker.series(fn1, fn2, fn3)(function(err, results) {
      t.deepEqual(results, [1, 2, 3]);
      if (err) { reject(err) } else { resolve();}
    }));
  });
  ...
  test('should take string names and functions', async function(t) {
    await new Promise((resolve, reject) => taker.series('test1', fn2, 'test3')(function(err, results) {
      t.deepEqual(results, [1, 2, 3]);
      if (err) { reject(err) } else { resolve();}
    }));
  });

  test('should take nested series', async function(t) {
    var series1 = taker.series('test1', 'test2', 'test3');
    await new Promise((resolve, reject) => taker.series('test1', series1, 'test3')(function(err, results) {
  ...
  test('should stop processing on error', async function(t) {
    ...
    await new Promise(resolve => taker.series('test1', 'error', 'test3')(function(err, results) {

...
test("should execute functions in series, passing settled results", async function(t) {
  t.plan(2);
...
test("should execute functions in series, passing settled errors and results", function(t) {
  t.plan(3);

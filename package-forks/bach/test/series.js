...
test("should execute functions in series, passing results", async function(t) {
  t.plan(2);
...
test("should execute functions in series, passing error", async function(t) {
  t.plan(2);
  ...
  return new Promise((resolve) =>
    bach.series(
      ...
      t.deepEqual(results, [1, 2, 3, undefined]);
      resolve();
    })
  );
});

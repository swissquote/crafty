...
- [`crafty-preset-vitest`](05_Packages/05_crafty-preset-vitest) This preset will add Vitest to the `crafty test` command, works with Babel, TypeScript, React, and SWC.

...
> Snapshot 1

    {
      ...
      css/style.scss␊
       ...
       57:1  ⚠  Unexpected browser feature "fullscreen" is only partially supported by Safari 15,15.4,15.5,15.6,16.0,16.1,16.2,16.3,15.1,15.2-15.3, Safari on iOS 15.0-15.1,15.2-15.3,15.4,15.5,15.6-15.8,16.0,16.1,16.2,16.3,16.4,16.5,16.6-16.7,17.0,17.1,17.2,17.3,17.4  plugin/no-unsupported-browser-features␊
      ␊

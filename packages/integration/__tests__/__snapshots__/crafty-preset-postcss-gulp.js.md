...
> Snapshot 1

    {
      ...
      ␊
      css/style.scss␊
       57:1  ⚠  Unexpected browser feature "fullscreen" is only partially supported by Safari 15,15.4,15.5,15.6,16.0,16.1,16.2,16.3,15.1,15.2-15.3, Safari on iOS 15.0-15.1,15.2-15.3,15.4,15.5,15.6-15.7,16.0,16.1,16.2,16.3,16.4,16.5  plugin/no-unsupported-browser-features␊
      ␊

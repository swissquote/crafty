...
> Snapshot 2
    ...
    return React.createElement("div",{onClick:this.handleClick},"Hey ",this.state.hey)}}class l extends React.Component{constructor(){super(...arguments),i(this,"handleClick",(()=>{this.setState({hey:!0})}))}render(){/*#__PURE__*/␊

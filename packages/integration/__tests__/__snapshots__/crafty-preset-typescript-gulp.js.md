...
> Snapshot 2
    ...
    `import test from"./Component";class NewStuff{method(){console.log(test(2,4));import("./SomeLibrary").then(SomeLibrary=>{const som=new SomeLibrary.default;console.log(som.add(2,4))})}constructor(){console.log("init class")}}export{NewStuff as default};//# sourceMappingURL=script.js.map␊
    `
...
> Snapshot 2
    ...
    `import test from"./Component.mjs";class NewStuff{method(){console.log(test(2,4));import("./SomeLibrary.mjs").then(SomeLibrary=>{const som=new SomeLibrary.default;console.log(som.add(2,4))})}constructor(){console.log("init class")}}export{NewStuff as default};//# sourceMappingURL=script.mjs.map␊
    `
...
> Snapshot 2
    ...
    import test from"./Component";class NewStuff{method(){console.log(test(2,4));import("./SomeLibrary").then(SomeLibrary=>{const som=new SomeLibrary.default;console.log(som.add(2,4))})}constructor(){console.log("init class")}}export{NewStuff as default};//# sourceMappingURL=myBundle.min.js.map␊
    `

...
> Snapshot 1

    {
      ...
      asset 8.myBundle.min.js ___ KiB [emitted] [minimized]␊
        sourceMap 8.myBundle.min.js.map ___ KiB [emitted] [dev]␊
      Entrypoint default ___ KiB (___ KiB) = myBundle.min.js 1 auxiliary asset␊
      chunk (runtime: default) 8.myBundle.min.js ___ KiB [rendered]␊
...
> Snapshot 4
    ...
    `"use strict";(self.webpackChunkUNIQID=self.webpackChunkUNIQID||[]).push([[8],{8:function(s,e,t){t.r(e),t.d(e,{default:function(){return c}});class c{constructor(s){this.field=s}sayHi(){console.log(this.field)}}}}]);␊
    //# sourceMappingURL=8.myBundle.min.js.map`

...
test("Compiles CSS within rspack", async () => {
  const cwd = await testUtils.getCleanFixtures(
    "crafty-preset-postcss-rspack/compiles"
  );
...
test("Fails gracefully on broken markup", async () => {
  const cwd = await testUtils.getCleanFixtures(
    "crafty-preset-postcss-rspack/fails"
  );
...
test("Compiles CSS within rspack, extracts CSS ('extractCSS' boolean option)", async () => {
  const cwd = await testUtils.getCleanFixtures(
    "crafty-preset-postcss-rspack/extract-boolean"
  );
...
test("Compiles CSS within rspack, extracts CSS ('extractCSS' string option)", async () => {
  const cwd = await testUtils.getCleanFixtures(
    "crafty-preset-postcss-rspack/extract-string"
  );
...
test("Compiles CSS within rspack, extracts CSS ('extractCSS' object option)", async () => {
  const cwd = await testUtils.getCleanFixtures(
    "crafty-preset-postcss-rspack/extract-object"
  );
...
test("Compiles CSS within rspack, CSS Modules, inline", async () => {
  const cwd = await testUtils.getCleanFixtures(
    "crafty-preset-postcss-rspack/modules-inline"
  );
...
test("Compiles CSS within rspack, CSS Modules, extracts CSS", async () => {
  const cwd = await testUtils.getCleanFixtures(
    "crafty-preset-postcss-rspack/modules-extract"
  );

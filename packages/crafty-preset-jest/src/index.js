...
function normalizeJestOptions(crafty, cli, moduleMode, args) {
  ...
  if (!moduleMode) {
    ...
    options.transform["[/\\\\]node_modules[/\\\\].+\\.js$"] = require.resolve(
      "./esm-transformer"
    );
  }
...
module.exports = {
  ide(crafty, input, cli) {
    const moduleMode = isModuleMode();
    return {
      "jest.config.js": {
        content: normalizeJestOptions(crafty, cli, moduleMode, []),
...
`
  ...
  test(crafty, input, cli) {
    return new Promise((resolve, reject) => {
      ...
      const options = normalizeJestOptions(crafty, cli, moduleMode, argv);

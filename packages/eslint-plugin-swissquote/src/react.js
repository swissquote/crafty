...
const eslintReact = require("../packages/eslint-react-eslint-plugin.js").configs.recommended;
...
module.exports = {
  ...
  rules: {
    ...
    ...require("../packages/eslint-plugin-react-hooks.js").configs.recommended.rules,
